...
H.append("<div class=topbar><div><h1>Command Code dashboard</h1><p class=sub>" + ("Public build, names redacted · " if PUBLIC else "") + f"Rendered {datetime.date.today()} · <code>{esc(redact(TASTE))}</code></p></div>")
